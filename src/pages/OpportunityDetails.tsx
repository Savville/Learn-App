...
import { Calendar, ExternalLink, ArrowLeft, Tag, Bell, CheckCircle, Flag, Share2, Linkedin, Twitter, Link as LinkIcon } from 'lucide-react';
              ...
              <div className="flex items-center justify-start gap-3 w-full sm:w-auto">
                ...
                <Dialog>
                  <DialogTrigger asChild>
                    <Button variant="outline" className="rounded-full shadow-sm hover:text-blue-600 hover:bg-blue-50">
                  ...
                  <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                      ...
                      <DialogDescription className="sr-only">
                        Choose an app to share this opportunity with your network.
                      </DialogDescription>
                    </DialogHeader>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 py-4">
                      ...
                      <a
                        href={`https://wa.me/?text=${encodeURIComponent(`Check out this opportunity: ${window.location.href}`)}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex flex-col items-center gap-2 p-3 rounded-xl hover:bg-slate-100 transition-colors"
                      >
                      ...
                      <a
                        href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent('Check out this opportunity')}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex flex-col items-center gap-2 p-3 rounded-xl hover:bg-slate-100 transition-colors"
                      >
