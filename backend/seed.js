...
const opportunities = [
  ...
  },
  {
    ...
    "eligibility": {
      "educationLevel": "All",
      "requirements": [
        "Interest in green building materials",
        "Support for lab testing fees"
      ]
    },
    "benefits": [
  ...
  },
  {
    ...
    "eligibility": {
      "educationLevel": "All",
      "requirements": [
        "Interest in agricultural waste recycling",
        "Funding for transport and kiln rental"
      ]
    },
    "benefits": [
    ...
    "thematicAreas": [
      {
        ...
        "topics": [
          "Low-cost acoustic or pressure sensors",
          "Community-based leak reporting systems",
      ...
      },
      {
        ...
        "topics": [
          ...
          "AI anomaly detection in consumption data",
      ...
      },
      {
        ...
        "topics": [
          "Affordable IoT meter design",
          "Prepaid water systems for informal settlements",
      ...
      },
      {
        ...
        "topics": [
          ...
          "Behavioural nudge interventions",
      ...
      },
      {
        ...
        "topics": [
          ...
          "Low-pressure zone risk mapping",
          "Waterborne disease early warning systems"
        ]
      },
      {
        ...
        "topics": [
          ...
          "Industrial grey water reuse systems",
          "Urban aquifer recharge strategies"
        ]
      }
    ],
    "views": 0,
    ...
    "thematicAreas": [
      {
        "heading": "General",
        "topics": [
          "All academic fields (excluding aviation, nuclear technology, and military training)"
        ]
      }
    ],
    "views": 0,
...
async function seedDatabase() {
  ...
  try {
    ...
    console.log(`📥 Upserting ${opportunities.length} opportunities (preserving real payment data)...`);

    const bulkOps = opportunities.map(({ fundedAmount, views, clicks, ...rest }) => ({
      updateOne: {
        filter: { id: rest.id },
        update: {
          // Update all metadata fields (title, description, etc.)
          $set: rest,
          // Only set financial/analytics fields if this is a brand new document
          $setOnInsert: {
    ...
    console.log(`✅ Done! Upserted: ${result.upsertedCount} new | Modified: ${result.modifiedCount} existing`);
    console.log('💰 Existing fundedAmount, views, and clicks were preserved.');
  } catch (error) {
